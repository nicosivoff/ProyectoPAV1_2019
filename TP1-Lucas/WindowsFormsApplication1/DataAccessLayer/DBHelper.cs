...
namespace TrabajoPractico.DataAccessLayer
{
    class DBHelper
    {
        ...
        private string cadenaConexion = @"Provider=SQLNCLI11;Data Source=MAQUIS;Persist Security Info=True;User ID=avisuales1;Initial Catalog=Canario;Password=avisuales1";
